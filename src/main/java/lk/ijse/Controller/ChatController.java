...
public class ChatController implements Initializable {
    ...
    private void appendText(String text) {
        ...
        messageLbl.setStyle("-fx-background-color:  #ff0000;-fx-background-radius:15;-fx-font-size: 18;-fx-font-weight: normal;-fx-text-fill: white;-fx-wrap-text: true;-fx-alignment: center-left;-fx-content-display: left;-fx-padding: 10;-fx-max-width: 350;");
    ...
    public void writeMessage(String message) {
        ...
        messageLbl.setStyle("-fx-background-color:   #4f0000;-fx-background-radius:15;-fx-font-size: 16;-fx-font-weight: normal;-fx-text-fill: white;-fx-wrap-text: true;-fx-alignment: center-left;-fx-content-display: left;-fx-padding: 10;-fx-max-width: 350;");
        hBox.getChildren().add(messageLbl);
